...
#    orders.limit(5).show()
    ...
    weather_pc = session.table("SNOWPARK_FOR_PYTHON__HANDSONLAB__WEATHER_DATA.ONPOINT_ID.FORECAST_DAY")
    countries = session.table("RAW_POS.COUNTRY")
    weather = session.table("SNOWPARK_FOR_PYTHON__HANDSONLAB__WEATHER_DATA.ONPOINT_ID.HISTORY_DAY")
